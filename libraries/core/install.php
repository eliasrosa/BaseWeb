...
class bwInstall
{
    ...
    public function __construct($params)
    {
        ...
        switch ($opcoes) {
            case 'create-config':
                $this->createConfig(
                    $this->getParms('h', 'localhost'), $this->getParms('u', 'root'), $this->getParms('s', ''), $this->getParms('p', '3306'), $this->getParms('b', 'baseweb'), 0
                );
                break;
    ...
    private function update()
    {
        ...
        if (method_exists($this, $method)) {
            ...
            $this->createConfig(
                bwConfig::$db_host, bwConfig::$db_user, bwConfig::$db_pass, bwConfig::$db_port, bwConfig::$db_name, $versao
            );
